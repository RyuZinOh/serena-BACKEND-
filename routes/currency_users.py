...
import jwt
from services.currency_service import get_user_currency, get_user_photo
...
@currency_bp.route('/<user_id>/photo', methods=['GET'])
def get_photo(user_id):
    ...
    photo_data = get_user_photo(user_id)
    if not photo_data:
        return jsonify({'message': 'Photo not found for this user!'}), 404
